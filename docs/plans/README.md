...
## Before M3 — Cursor CLI residue

Conveyor was designed against Claude Code and switched to Cursor CLI. `bin/` and `lib/` made the switch; these plans cover what the switch did not re-examine.
